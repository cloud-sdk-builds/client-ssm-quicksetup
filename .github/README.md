...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.692.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.692.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IjZmf0Zd8xWXwJkSYMrmTa3pWqa/eoP3yAL6JEJ8YqQIY8iMtHd3b3ffCKChbshH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.692.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.692.0/index.min.mjs": "sha384-IjZmf0Zd8xWXwJkSYMrmTa3pWqa/eoP3yAL6JEJ8YqQIY8iMtHd3b3ffCKChbshH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.692.0/LICENSE
```

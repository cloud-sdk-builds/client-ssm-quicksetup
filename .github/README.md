...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.999.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.999.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-84cXbkKkRrmHCYrcdjB5J7HcqBacb8BICzxMmOvkMmSkgulrOM4YV30esQJU6Y7L
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.999.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.999.0/index.min.mjs": "sha384-84cXbkKkRrmHCYrcdjB5J7HcqBacb8BICzxMmOvkMmSkgulrOM4YV30esQJU6Y7L"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.999.0/LICENSE
```

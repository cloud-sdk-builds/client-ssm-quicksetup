...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.799.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.799.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-J14hFR6gQAvq/ah1mRJGGoArxKl5RJ7EdUdIZX/qQIwh2DtLQQuDRYQd9rGZNFt6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.799.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.799.0/index.min.mjs": "sha384-J14hFR6gQAvq/ah1mRJGGoArxKl5RJ7EdUdIZX/qQIwh2DtLQQuDRYQd9rGZNFt6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.799.0/LICENSE
```

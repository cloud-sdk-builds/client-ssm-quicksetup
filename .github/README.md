...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.649.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.649.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aull1S44+E3WnpQvl1sEaNb79NsVPHnm/6K2tNKLQlOKV/jxoGOTetwRl/GPs1GS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.649.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.649.0/index.min.mjs": "sha384-aull1S44+E3WnpQvl1sEaNb79NsVPHnm/6K2tNKLQlOKV/jxoGOTetwRl/GPs1GS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.649.0/LICENSE
```

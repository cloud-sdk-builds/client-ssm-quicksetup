...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.886.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.886.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AzLqHWqEah9MfvY/HTM/CUbG1T5N03elFyn6ihB5usUvKkc4WHyBqmfqA4pmliMI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.886.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.886.0/index.min.mjs": "sha384-AzLqHWqEah9MfvY/HTM/CUbG1T5N03elFyn6ihB5usUvKkc4WHyBqmfqA4pmliMI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.886.0/LICENSE
```

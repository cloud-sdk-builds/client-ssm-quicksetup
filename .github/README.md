...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.967.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.967.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DD7TJjrDPRxSb8hvhUZHat+ZiOIQ8OLHsP6w5J3KKvQ6W1ZtK+HlEl2RIlwbUMHO
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.967.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.967.0/index.min.mjs": "sha384-DD7TJjrDPRxSb8hvhUZHat+ZiOIQ8OLHsP6w5J3KKvQ6W1ZtK+HlEl2RIlwbUMHO"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.967.0/LICENSE
```

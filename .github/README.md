...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.921.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.921.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+HnJmE+VSBbqiodkfChp0R4Ak4A+UFxGl+/NwbCh9fBrLnyxcfHcmWxX65lgQ+Rt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.921.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.921.0/index.min.mjs": "sha384-+HnJmE+VSBbqiodkfChp0R4Ak4A+UFxGl+/NwbCh9fBrLnyxcfHcmWxX65lgQ+Rt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.921.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.988.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.988.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-pBmOpmdG6OIyF+4LB+vMpIoIBr5764DBogUlql0qDMy3l3cK1odk3B67S3Zw+FvF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.988.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.988.0/index.min.mjs": "sha384-pBmOpmdG6OIyF+4LB+vMpIoIBr5764DBogUlql0qDMy3l3cK1odk3B67S3Zw+FvF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.988.0/LICENSE
```

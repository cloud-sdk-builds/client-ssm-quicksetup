...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.896.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.896.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-PSKab9r1xyORIqXJmOiXZfm4wjIRRoERUlL7C4VhkcRNhBpyYfDEvczaJad2jZ5f
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.896.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.896.0/index.min.mjs": "sha384-PSKab9r1xyORIqXJmOiXZfm4wjIRRoERUlL7C4VhkcRNhBpyYfDEvczaJad2jZ5f"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.896.0/LICENSE
```

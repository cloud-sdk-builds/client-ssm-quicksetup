...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.823.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.823.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rfv/Jz4zJe+8MlOuc+SfFd/YoKkWnzUZH7K+wR0FUAMfGJKzUwQLag5K9Fz8vIKS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.823.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.823.0/index.min.mjs": "sha384-rfv/Jz4zJe+8MlOuc+SfFd/YoKkWnzUZH7K+wR0FUAMfGJKzUwQLag5K9Fz8vIKS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.823.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.665.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.665.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MDfuDn1mGhfZJgLHoR0yVHiggItjjVXBQ7dJtzF7a4JYTumJ5DPdhzc7R9dZfifq
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.665.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.665.0/index.min.mjs": "sha384-MDfuDn1mGhfZJgLHoR0yVHiggItjjVXBQ7dJtzF7a4JYTumJ5DPdhzc7R9dZfifq"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.665.0/LICENSE
```

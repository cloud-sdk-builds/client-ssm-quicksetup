...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.957.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.957.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xhKIJ4jqbqFP91tsF7J2WzU5XgRMDRKE7AoNxYGXSi6QUwTWd6QElb6kyOHx+7D5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.957.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.957.0/index.min.mjs": "sha384-xhKIJ4jqbqFP91tsF7J2WzU5XgRMDRKE7AoNxYGXSi6QUwTWd6QElb6kyOHx+7D5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.957.0/LICENSE
```

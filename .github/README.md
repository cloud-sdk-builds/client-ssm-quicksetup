...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.993.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.993.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ql6M+/njYWpwQIw2tjbkA2wUNzayap6f3syjhF7ullo/JD2U4BFVWSpVPrA9GVQZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.993.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.993.0/index.min.mjs": "sha384-ql6M+/njYWpwQIw2tjbkA2wUNzayap6f3syjhF7ullo/JD2U4BFVWSpVPrA9GVQZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.993.0/LICENSE
```

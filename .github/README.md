...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.887.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.887.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ggch6Xp1W4GFPpxPKZICBJHlISCD9wulUZL6YF3AqmChX6jgTJsgH24MOhJ+PsRx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.887.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.887.0/index.min.mjs": "sha384-ggch6Xp1W4GFPpxPKZICBJHlISCD9wulUZL6YF3AqmChX6jgTJsgH24MOhJ+PsRx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.887.0/LICENSE
```

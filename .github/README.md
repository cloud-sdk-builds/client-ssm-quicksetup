...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.635.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.635.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-kcEubyzXlQd3EiO642HznTCPxiiCMLOBAXoLzWS0paakdq7HO7qmd7bMAcsI9KgM
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.635.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.635.0/index.min.mjs": "sha384-kcEubyzXlQd3EiO642HznTCPxiiCMLOBAXoLzWS0paakdq7HO7qmd7bMAcsI9KgM"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.635.0/LICENSE
```

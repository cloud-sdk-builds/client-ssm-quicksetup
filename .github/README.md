...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.712.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.712.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ur9muwbAbjSi22kd3XAiA10qyOa1YJDBveK2K0KG/3TENv3iY/8F7OE0yQYty1oD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.712.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.712.0/index.min.mjs": "sha384-ur9muwbAbjSi22kd3XAiA10qyOa1YJDBveK2K0KG/3TENv3iY/8F7OE0yQYty1oD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.712.0/LICENSE
```

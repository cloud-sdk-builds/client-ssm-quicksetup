...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.645.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.645.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-570oPfx6xVNNhZaVm+zt9chV9x/Ly9LXBHQK/ZTG9Qdok5+mGZCN1LXmPoYoDnmK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.645.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.645.0/index.min.mjs": "sha384-570oPfx6xVNNhZaVm+zt9chV9x/Ly9LXBHQK/ZTG9Qdok5+mGZCN1LXmPoYoDnmK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.645.0/LICENSE
```

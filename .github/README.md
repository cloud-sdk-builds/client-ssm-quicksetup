...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.662.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.662.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4z0HUgu8I3pyvdzYQSjPusWuPsgVF1qmczrJ3oLMKszpgDOzO0xUb0uat4OkusdU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.662.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.662.0/index.min.mjs": "sha384-4z0HUgu8I3pyvdzYQSjPusWuPsgVF1qmczrJ3oLMKszpgDOzO0xUb0uat4OkusdU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.662.0/LICENSE
```

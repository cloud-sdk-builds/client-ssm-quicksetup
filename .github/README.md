...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.996.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.996.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n6PBvmdujJlnHuKT4pitQBZB5mj3zFv/zIU3mBo77wmUADmTbnYPdu8aYxDx4eRV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.996.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.996.0/index.min.mjs": "sha384-n6PBvmdujJlnHuKT4pitQBZB5mj3zFv/zIU3mBo77wmUADmTbnYPdu8aYxDx4eRV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.996.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.947.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.947.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FHew3v+4gxpLe5iK2BxGsnwXKi2+FvAD5uMKnldQRnHqYgsZ7qDAvbpgNLyzQn8K
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.947.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.947.0/index.min.mjs": "sha384-FHew3v+4gxpLe5iK2BxGsnwXKi2+FvAD5uMKnldQRnHqYgsZ7qDAvbpgNLyzQn8K"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.947.0/LICENSE
```

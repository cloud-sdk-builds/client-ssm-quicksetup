...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.709.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.709.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gJQscSiZuafDXtl/v+3PqqHnmhBfIezX5IKbzdPP1ktz6CQm9OJRze2FJNxaokov
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.709.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.709.0/index.min.mjs": "sha384-gJQscSiZuafDXtl/v+3PqqHnmhBfIezX5IKbzdPP1ktz6CQm9OJRze2FJNxaokov"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.709.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.668.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.668.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-puXFzZbZX/CKjRYhhm62m63MwFkFAjhsSwpIjAU7Q/6difItO6JGC+Y2FlVbUa3T
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.668.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.668.0/index.min.mjs": "sha384-puXFzZbZX/CKjRYhhm62m63MwFkFAjhsSwpIjAU7Q/6difItO6JGC+Y2FlVbUa3T"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.668.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.965.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.965.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b9hfO6MmsaATQtMb/Jwlm0ek8mILwoXjBEwK3omK8vU/qqcZp9CtZcPx0+kuE1DU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.965.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.965.0/index.min.mjs": "sha384-b9hfO6MmsaATQtMb/Jwlm0ek8mILwoXjBEwK3omK8vU/qqcZp9CtZcPx0+kuE1DU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.965.0/LICENSE
```

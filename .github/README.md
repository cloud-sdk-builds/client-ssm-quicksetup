...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.932.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.932.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6PcQHKltcUBsV43qJ0pcfKEKqeqtQ93rEF5uTpGT7VSbDdQdOUhM5hBoqZw5gX0X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.932.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.932.0/index.min.mjs": "sha384-6PcQHKltcUBsV43qJ0pcfKEKqeqtQ93rEF5uTpGT7VSbDdQdOUhM5hBoqZw5gX0X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.932.0/LICENSE
```

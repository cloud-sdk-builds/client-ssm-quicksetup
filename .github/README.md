...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.933.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.933.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YdUXe+VddVOqR0BBZOS+lWHTJJL/65fOd+reAJPSNTIF4c7v54tQIPInLGTIzLc8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.933.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.933.0/index.min.mjs": "sha384-YdUXe+VddVOqR0BBZOS+lWHTJJL/65fOd+reAJPSNTIF4c7v54tQIPInLGTIzLc8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.933.0/LICENSE
```

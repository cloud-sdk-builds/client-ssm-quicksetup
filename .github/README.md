...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.931.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.931.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-u1bGkcudwB8KFWebDmAl/2aFlAl9BL8clkLBazZx3haoLLWw7506rCsJ6ECRdzOC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.931.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.931.0/index.min.mjs": "sha384-u1bGkcudwB8KFWebDmAl/2aFlAl9BL8clkLBazZx3haoLLWw7506rCsJ6ECRdzOC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.931.0/LICENSE
```

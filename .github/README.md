...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.743.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.743.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-n/mS/6eGKK69UmfUkzRbk0eKrQwtOnK2CbA1Ee2y81vngRJpEduojkd5RQo+T9A/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.743.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.743.0/index.min.mjs": "sha384-n/mS/6eGKK69UmfUkzRbk0eKrQwtOnK2CbA1Ee2y81vngRJpEduojkd5RQo+T9A/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.743.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.952.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.952.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2Y6QJZ2ViXfM6zy2NfJJ9c4rrgNm8Z4GV0PztUqdirpHceQ2XOvVUKiJsztAvE9Q
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.952.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.952.0/index.min.mjs": "sha384-2Y6QJZ2ViXfM6zy2NfJJ9c4rrgNm8Z4GV0PztUqdirpHceQ2XOvVUKiJsztAvE9Q"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.952.0/LICENSE
```

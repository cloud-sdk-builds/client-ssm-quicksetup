...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.624.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.624.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-QfMLuceknRz9kG1xO5yqRudYqYon0axoyFOzeUQ9yVgthIs6hlre5Le3BbZZo/3Z
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.624.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.624.0/index.min.mjs": "sha384-QfMLuceknRz9kG1xO5yqRudYqYon0axoyFOzeUQ9yVgthIs6hlre5Le3BbZZo/3Z"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.624.0/LICENSE
```

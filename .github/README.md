...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.738.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.738.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-inWUKnjoFQxa5MB7Imx9QuE2zVGShly2WELXpMh14ZUKXY9uG+H2yb68//8s8Iq1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.738.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.738.0/index.min.mjs": "sha384-inWUKnjoFQxa5MB7Imx9QuE2zVGShly2WELXpMh14ZUKXY9uG+H2yb68//8s8Iq1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.738.0/LICENSE
```

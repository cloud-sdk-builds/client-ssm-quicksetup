...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.936.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.936.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-crOhnNwlfO+EWszp93W0Kz0umPiGekBzZLRTuPKqGzzFgZpdlXIm9ELvb+9I6fNZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.936.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.936.0/index.min.mjs": "sha384-crOhnNwlfO+EWszp93W0Kz0umPiGekBzZLRTuPKqGzzFgZpdlXIm9ELvb+9I6fNZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.936.0/LICENSE
```

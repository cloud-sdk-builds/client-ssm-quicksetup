...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.882.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.882.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-M3oAYAaMRv0gMWRs0qCyQYzIGEDNdhysDbhjzKoaL5j5JLfm3hEopLLS0vAau0lm
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.882.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.882.0/index.min.mjs": "sha384-M3oAYAaMRv0gMWRs0qCyQYzIGEDNdhysDbhjzKoaL5j5JLfm3hEopLLS0vAau0lm"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.882.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.744.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.744.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-cYx8if46+oQE5NOF9Sb056Fcgbpq2xZQfgYoQuQaazPIMBhQh5BcKuuGJ2nFRd/r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.744.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.744.0/index.min.mjs": "sha384-cYx8if46+oQE5NOF9Sb056Fcgbpq2xZQfgYoQuQaazPIMBhQh5BcKuuGJ2nFRd/r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.744.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.964.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.964.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-5iRJ5U9s27wQql3a4ILkNR7ixYOjZjLpHYKh1G+l6wsNAjhfxG8wwLNgaF1ph2J/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.964.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.964.0/index.min.mjs": "sha384-5iRJ5U9s27wQql3a4ILkNR7ixYOjZjLpHYKh1G+l6wsNAjhfxG8wwLNgaF1ph2J/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.964.0/LICENSE
```

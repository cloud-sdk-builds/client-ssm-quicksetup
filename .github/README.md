...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.876.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.876.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rJc2DVECELf7a6cMibyJtfiz2GNEnV4ESjxQRZ1klMm5FAjz3UgtJoHksPMpTkdu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.876.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.876.0/index.min.mjs": "sha384-rJc2DVECELf7a6cMibyJtfiz2GNEnV4ESjxQRZ1klMm5FAjz3UgtJoHksPMpTkdu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.876.0/LICENSE
```

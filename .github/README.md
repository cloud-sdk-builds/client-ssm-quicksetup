...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.682.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.682.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-0N2FKI+bFXJLxi9sxwctxrkq26pS/iG68SitSrDjtnDpadyhxWQ7PduL2wVNcOXo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.682.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.682.0/index.min.mjs": "sha384-0N2FKI+bFXJLxi9sxwctxrkq26pS/iG68SitSrDjtnDpadyhxWQ7PduL2wVNcOXo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.682.0/LICENSE
```

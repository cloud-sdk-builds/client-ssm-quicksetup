...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.777.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.777.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GJykmoZek52XGoIiBXTvEpYS7qCK2nmkjgutjuKTV14JD2vSQpE7MXcTcUJL/VNd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.777.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.777.0/index.min.mjs": "sha384-GJykmoZek52XGoIiBXTvEpYS7qCK2nmkjgutjuKTV14JD2vSQpE7MXcTcUJL/VNd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.777.0/LICENSE
```

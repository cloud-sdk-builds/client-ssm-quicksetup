...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.948.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.948.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-v7YIYFoSLzncg50pzuY/aFDF+nE8K48rX2EqVrH9kGTh6Hpex6q82sZ5gUrvjLgx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.948.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.948.0/index.min.mjs": "sha384-v7YIYFoSLzncg50pzuY/aFDF+nE8K48rX2EqVrH9kGTh6Hpex6q82sZ5gUrvjLgx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.948.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.966.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.966.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HWMpnazHNqb7hCb8f3bJAFFqqvZwIILNf/R4Y7EYDa61a5jpn5aIdmED1ZbbFgj8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.966.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.966.0/index.min.mjs": "sha384-HWMpnazHNqb7hCb8f3bJAFFqqvZwIILNf/R4Y7EYDa61a5jpn5aIdmED1ZbbFgj8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.966.0/LICENSE
```

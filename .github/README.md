...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.916.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.916.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Hj8JOyAXBTX/LdJ/vr2SIj3h1eJaQ9XWxVhzlNtZXuxG1+JvxdkZ9GVzp+/lK1hz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.916.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.916.0/index.min.mjs": "sha384-Hj8JOyAXBTX/LdJ/vr2SIj3h1eJaQ9XWxVhzlNtZXuxG1+JvxdkZ9GVzp+/lK1hz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.916.0/LICENSE
```

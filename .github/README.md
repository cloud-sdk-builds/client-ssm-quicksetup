...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.940.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.940.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-mJ/QzDcRq7VuY3L5HHtjOqY/GuJKUhTP38lV72ybrF3HF7F8mf3B3wT7HopQKfYf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.940.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.940.0/index.min.mjs": "sha384-mJ/QzDcRq7VuY3L5HHtjOqY/GuJKUhTP38lV72ybrF3HF7F8mf3B3wT7HopQKfYf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.940.0/LICENSE
```

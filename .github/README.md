...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.687.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.687.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6s+Ah4h5Z6gPMF/5UASXqCD+7DrWxa2XFNr6KW+ITypomCVT1nlSt6MANjXslAMC
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.687.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.687.0/index.min.mjs": "sha384-6s+Ah4h5Z6gPMF/5UASXqCD+7DrWxa2XFNr6KW+ITypomCVT1nlSt6MANjXslAMC"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.687.0/LICENSE
```

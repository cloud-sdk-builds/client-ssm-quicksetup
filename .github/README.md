...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.954.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.954.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-xndXlbaPMsVZEbiNdNCTdU/OXCgif87NwLsH4DPEQijGOf0bijEIgwV7vOh7/0bt
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.954.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.954.0/index.min.mjs": "sha384-xndXlbaPMsVZEbiNdNCTdU/OXCgif87NwLsH4DPEQijGOf0bijEIgwV7vOh7/0bt"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.954.0/LICENSE
```

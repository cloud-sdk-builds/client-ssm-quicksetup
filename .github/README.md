...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.664.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.664.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-AB+xoQLl5yo0LC6Ph6EO+OfS7jhJfkm7jWeTly5EdA2nIofFli8Kq23cwUE/Ktrj
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.664.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.664.0/index.min.mjs": "sha384-AB+xoQLl5yo0LC6Ph6EO+OfS7jhJfkm7jWeTly5EdA2nIofFli8Kq23cwUE/Ktrj"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.664.0/LICENSE
```

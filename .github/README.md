...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.772.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.772.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bd6R6odl7gNkC/Icfp0dCF8sEo4vXM9+BCKFVFZ7w87gGx4iAlOVgZcX0SukG4fv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.772.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.772.0/index.min.mjs": "sha384-bd6R6odl7gNkC/Icfp0dCF8sEo4vXM9+BCKFVFZ7w87gGx4iAlOVgZcX0SukG4fv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.772.0/LICENSE
```

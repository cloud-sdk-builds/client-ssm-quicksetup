...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.651.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.651.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-i+BWoBkjlk2h4p70+mj2oCtGOZV2DWH1aSaDnVXa3v5gxKmh9yFibxkZNCDvpIKI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.651.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.651.1/index.min.mjs": "sha384-i+BWoBkjlk2h4p70+mj2oCtGOZV2DWH1aSaDnVXa3v5gxKmh9yFibxkZNCDvpIKI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.651.1/LICENSE
```

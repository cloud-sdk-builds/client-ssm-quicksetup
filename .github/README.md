...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.984.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.984.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bvJRy4aJ69u4aaBEn71xs4r+MYv0lxZFfT8/GwTMW7UgX0r8JRJCVi8+S2l87dCD
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.984.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.984.0/index.min.mjs": "sha384-bvJRy4aJ69u4aaBEn71xs4r+MYv0lxZFfT8/GwTMW7UgX0r8JRJCVi8+S2l87dCD"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.984.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.934.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.934.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MqEOCqaNWKw/9RmI562K/0M6qj0mTH1b/uUNfrptdx6t813UAlvHxxafozCqzxg7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.934.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.934.0/index.min.mjs": "sha384-MqEOCqaNWKw/9RmI562K/0M6qj0mTH1b/uUNfrptdx6t813UAlvHxxafozCqzxg7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.934.0/LICENSE
```

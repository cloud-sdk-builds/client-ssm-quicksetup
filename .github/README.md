...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.946.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.946.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-gm2kDktGfthBSpr4ItUNoAZMCU5UcDnpz886ImISdQ4m3+vrK0zyDlC0jHcl6q49
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.946.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.946.0/index.min.mjs": "sha384-gm2kDktGfthBSpr4ItUNoAZMCU5UcDnpz886ImISdQ4m3+vrK0zyDlC0jHcl6q49"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.946.0/LICENSE
```

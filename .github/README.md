...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1031.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1031.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-b8kBbZgcxrv0jBMICfVgAkK1fl9K31Vr6ziv2gZogXP5Y6XFFufvuGOAR1twhDmV
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1031.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1031.0/index.min.mjs": "sha384-b8kBbZgcxrv0jBMICfVgAkK1fl9K31Vr6ziv2gZogXP5Y6XFFufvuGOAR1twhDmV"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1031.0/LICENSE
```

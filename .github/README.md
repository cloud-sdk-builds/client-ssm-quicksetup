...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.677.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.677.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yQCIIu/C1ubQ2g3RZVs3uhj7elzLY1QhRJ3VEH8LN8Zm0kmDuBlMlH89lJ2EMXHR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.677.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.677.0/index.min.mjs": "sha384-yQCIIu/C1ubQ2g3RZVs3uhj7elzLY1QhRJ3VEH8LN8Zm0kmDuBlMlH89lJ2EMXHR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.677.0/LICENSE
```

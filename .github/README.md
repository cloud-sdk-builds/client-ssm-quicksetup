...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.859.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.859.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Bvl22CypjdnHQeU87YgiL9XsphSNi2l8cEk2HcbshTspMNwF9zTqim3Y3U/yT0uH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.859.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.859.0/index.min.mjs": "sha384-Bvl22CypjdnHQeU87YgiL9XsphSNi2l8cEk2HcbshTspMNwF9zTqim3Y3U/yT0uH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.859.0/LICENSE
```

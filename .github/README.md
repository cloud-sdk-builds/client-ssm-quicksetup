...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.994.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.994.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-JckwmDoNvPKJT06uu6m9KNlYIIib1SbMoWMQhBKVT+t1vzTO5iOOg9s+n7kYzCtJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.994.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.994.0/index.min.mjs": "sha384-JckwmDoNvPKJT06uu6m9KNlYIIib1SbMoWMQhBKVT+t1vzTO5iOOg9s+n7kYzCtJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.994.0/LICENSE
```

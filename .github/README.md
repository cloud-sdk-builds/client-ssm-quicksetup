...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.622.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.622.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-osQgsr7voGHVVau8r9h6m54HTLBcEwQbE5Kv1PRAGqypG5lSbn90G32ljBHzaTxo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.622.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.622.0/index.min.mjs": "sha384-osQgsr7voGHVVau8r9h6m54HTLBcEwQbE5Kv1PRAGqypG5lSbn90G32ljBHzaTxo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.622.0/LICENSE
```

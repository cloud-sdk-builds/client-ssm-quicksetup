...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.835.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.835.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-INifQYGlqeT0sTuV2UfCDhS8IKLkE+7s+Hjtb1ZudQyu6xyHFedNhCbapzY8gaSH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.835.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.835.0/index.min.mjs": "sha384-INifQYGlqeT0sTuV2UfCDhS8IKLkE+7s+Hjtb1ZudQyu6xyHFedNhCbapzY8gaSH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.835.0/LICENSE
```

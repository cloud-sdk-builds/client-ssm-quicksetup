...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.926.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.926.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-C+5qZ7Tmwm4i5Y1ERm3/IGDAD2OAeTWpahgmt0yWBDTLYzxwfSjo1ckQD4jCiyEo
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.926.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.926.0/index.min.mjs": "sha384-C+5qZ7Tmwm4i5Y1ERm3/IGDAD2OAeTWpahgmt0yWBDTLYzxwfSjo1ckQD4jCiyEo"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.926.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.816.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.816.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uWmiPEnoEwIK4i/fyOsuIVAUzmF6uteqFUkCulXrk7pVg85GPSshN2bt2owAirYz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.816.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.816.0/index.min.mjs": "sha384-uWmiPEnoEwIK4i/fyOsuIVAUzmF6uteqFUkCulXrk7pVg85GPSshN2bt2owAirYz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.816.0/LICENSE
```

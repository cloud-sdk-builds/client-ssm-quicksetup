...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.699.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.699.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Evb4XL9PB51OT6pAwry9UmkqQNZOBeisOpHUJA7jrk/87KmravyKmlCmCCh3F6qb
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.699.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.699.0/index.min.mjs": "sha384-Evb4XL9PB51OT6pAwry9UmkqQNZOBeisOpHUJA7jrk/87KmravyKmlCmCCh3F6qb"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.699.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.856.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.856.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XOc2IHQugs71jEFEJqq6lx6ShLZ2Y1Lcd6x/2x5pPgTejrrUZ+gyq3YtCGxn8qpI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.856.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.856.0/index.min.mjs": "sha384-XOc2IHQugs71jEFEJqq6lx6ShLZ2Y1Lcd6x/2x5pPgTejrrUZ+gyq3YtCGxn8qpI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.856.0/LICENSE
```

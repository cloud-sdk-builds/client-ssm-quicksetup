...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.825.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.825.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iHfqKjCfRnL8B9EkvkC/H2p5tg4IXhX4S+ax/noW/EmTK5BdP10g4mzoTElFpKLf
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.825.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.825.0/index.min.mjs": "sha384-iHfqKjCfRnL8B9EkvkC/H2p5tg4IXhX4S+ax/noW/EmTK5BdP10g4mzoTElFpKLf"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.825.0/LICENSE
```

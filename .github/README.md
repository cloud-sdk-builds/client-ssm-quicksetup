...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.927.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.927.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qw0kn5+OwBsyeck5WL1oqJ40/Qgnvm8kDsItv/In5RB1Yqz+rnnyyEZXoSbm45Su
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.927.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.927.0/index.min.mjs": "sha384-qw0kn5+OwBsyeck5WL1oqJ40/Qgnvm8kDsItv/In5RB1Yqz+rnnyyEZXoSbm45Su"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.927.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.956.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.956.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-k5ZQIrCQItKA95VEjP6fa34nXhUxDOB001chZtGw0MnI7Ci41GQppfFkuisBglev
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.956.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.956.0/index.min.mjs": "sha384-k5ZQIrCQItKA95VEjP6fa34nXhUxDOB001chZtGw0MnI7Ci41GQppfFkuisBglev"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.956.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.990.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.990.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+dqncSQx3b/RG5FM3KZsPu7b58joWJ1HTKwZhevahvfBvobXEx92/uImdPEPx1xQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.990.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.990.0/index.min.mjs": "sha384-+dqncSQx3b/RG5FM3KZsPu7b58joWJ1HTKwZhevahvfBvobXEx92/uImdPEPx1xQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.990.0/LICENSE
```

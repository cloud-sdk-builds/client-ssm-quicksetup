...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.716.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.716.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Kl8Wxw3/IXj9lKvtDaK6h8MM0ZNCKRHapDmGCBIGD4+/l3bH4mmpNnDhT531yIgQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.716.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.716.0/index.min.mjs": "sha384-Kl8Wxw3/IXj9lKvtDaK6h8MM0ZNCKRHapDmGCBIGD4+/l3bH4mmpNnDhT531yIgQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.716.0/LICENSE
```

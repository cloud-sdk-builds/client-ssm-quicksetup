...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1027.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1027.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DQOUudeBu+peYqUSGe1IPkmCPkyYBLcO8JLK8kleKCZYbHNzFy10MCWevT4rJ/t9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1027.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1027.0/index.min.mjs": "sha384-DQOUudeBu+peYqUSGe1IPkmCPkyYBLcO8JLK8kleKCZYbHNzFy10MCWevT4rJ/t9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1027.0/LICENSE
```

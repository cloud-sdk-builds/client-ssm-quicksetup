...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.901.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.901.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-2nQiKDawwwaMk2HDi85/BJJJjyiTDxB+ds5Swtjt7mG5rAHbpeHGWTtrOLl9NULx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.901.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.901.0/index.min.mjs": "sha384-2nQiKDawwwaMk2HDi85/BJJJjyiTDxB+ds5Swtjt7mG5rAHbpeHGWTtrOLl9NULx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.901.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.992.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.992.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FgvDkSD50D/QpvZs0I/7SPbctkaLkjuCmcuTWr5IZXzejSvGPfHypu/gtczcclPS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.992.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.992.0/index.min.mjs": "sha384-FgvDkSD50D/QpvZs0I/7SPbctkaLkjuCmcuTWr5IZXzejSvGPfHypu/gtczcclPS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.992.0/LICENSE
```

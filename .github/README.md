...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.908.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.908.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lVnYYMI06jKarogvZwwNxx8XvsuGWDjNsDHmO0TdTW3Jo0cEJwi+lgzrRy0EwAgU
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.908.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.908.0/index.min.mjs": "sha384-lVnYYMI06jKarogvZwwNxx8XvsuGWDjNsDHmO0TdTW3Jo0cEJwi+lgzrRy0EwAgU"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.908.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1006.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1006.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bnL74fO+r1+A5twFdkrGuqm+Y70T4nsGzu4CM4dK4h1ti063R+kru7SgMiZZ1wDw
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1006.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1006.0/index.min.mjs": "sha384-bnL74fO+r1+A5twFdkrGuqm+Y70T4nsGzu4CM4dK4h1ti063R+kru7SgMiZZ1wDw"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1006.0/LICENSE
```

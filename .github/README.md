...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.972.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.972.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-93XhrLUabe/ou1xoWh3spIj+D35wtY/ta3nTBjVb4EzJXawgveaIg8VWjsBrn4b0
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.972.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.972.0/index.min.mjs": "sha384-93XhrLUabe/ou1xoWh3spIj+D35wtY/ta3nTBjVb4EzJXawgveaIg8VWjsBrn4b0"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.972.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1011.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1011.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-tFHl37pH20zmrdF1y7mBJNrGi5WnSh7ibzOwRwRpjgCjBhK/0bG1ucSQd0pMFwhs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1011.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1011.0/index.min.mjs": "sha384-tFHl37pH20zmrdF1y7mBJNrGi5WnSh7ibzOwRwRpjgCjBhK/0bG1ucSQd0pMFwhs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1011.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.911.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.911.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4naqGmOR4GKNFBlLFMtsnO8AE/X2kNrxVSJ7VS8tPRe+dTe8Vu3p7SImeTl0TTol
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.911.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.911.0/index.min.mjs": "sha384-4naqGmOR4GKNFBlLFMtsnO8AE/X2kNrxVSJ7VS8tPRe+dTe8Vu3p7SImeTl0TTol"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.911.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.839.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.839.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bsHbNVE6Ax280UouM9Yw1bk34yqsbMrVGqRZOMIMwXqvkq53S/TaG+OJ7PZl8ksi
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.839.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.839.0/index.min.mjs": "sha384-bsHbNVE6Ax280UouM9Yw1bk34yqsbMrVGqRZOMIMwXqvkq53S/TaG+OJ7PZl8ksi"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.839.0/LICENSE
```

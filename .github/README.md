...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.808.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.808.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V7y54C1KEYy3ajvfOj7gm38dKTE/FOmVU5B+W5ZNBXgca+ANe2TuSg7kBx0y7OMh
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.808.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.808.0/index.min.mjs": "sha384-V7y54C1KEYy3ajvfOj7gm38dKTE/FOmVU5B+W5ZNBXgca+ANe2TuSg7kBx0y7OMh"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.808.0/LICENSE
```

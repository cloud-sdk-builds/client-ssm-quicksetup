...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.796.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.796.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-7Kdy56Dx7z5vuWUT6rlM6lb7+CnFNfCO9Cfvbp7SNgnMnC5vn6LYZ/QGsB9ZbreF
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.796.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.796.0/index.min.mjs": "sha384-7Kdy56Dx7z5vuWUT6rlM6lb7+CnFNfCO9Cfvbp7SNgnMnC5vn6LYZ/QGsB9ZbreF"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.796.0/LICENSE
```

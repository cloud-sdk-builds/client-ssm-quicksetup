...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.734.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.734.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-orlHEorfT0rLUsU8GHcaTH2P1AGcarBI/HaIWZdNtpfGVZk5DSQiCG9NJLHCc9Og
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.734.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.734.0/index.min.mjs": "sha384-orlHEorfT0rLUsU8GHcaTH2P1AGcarBI/HaIWZdNtpfGVZk5DSQiCG9NJLHCc9Og"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.734.0/LICENSE
```

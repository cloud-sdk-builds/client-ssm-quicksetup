...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.787.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.787.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-iJueSf6nDCFalBb1gKg10QBhb0r7txV2+yCkXUJSmwmOiNK3DUqYTHQWUHQIAtnn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.787.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.787.0/index.min.mjs": "sha384-iJueSf6nDCFalBb1gKg10QBhb0r7txV2+yCkXUJSmwmOiNK3DUqYTHQWUHQIAtnn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.787.0/LICENSE
```

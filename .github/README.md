...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1038.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1038.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uIPW2LcaWzasv7ztV6TSDubrkIsT+18VUxRdu0MZbrjvxoXYEFDBTuVJOQZrxclx
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1038.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1038.0/index.min.mjs": "sha384-uIPW2LcaWzasv7ztV6TSDubrkIsT+18VUxRdu0MZbrjvxoXYEFDBTuVJOQZrxclx"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1038.0/LICENSE
```

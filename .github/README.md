...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.955.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.955.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-IpIO4GFghgJkd+tn2eAgYBCEOkbY5rTd4hTFn1dZEFMMqGC+xsCXkK0KM4FqNYSI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.955.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.955.0/index.min.mjs": "sha384-IpIO4GFghgJkd+tn2eAgYBCEOkbY5rTd4hTFn1dZEFMMqGC+xsCXkK0KM4FqNYSI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.955.0/LICENSE
```

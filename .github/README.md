...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.929.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.929.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LkLZwIP5p0KOZUY5QUuW/kmmJv8CSOLTJ9hbd+5Qz5M2ehw/ELZTg14ExSNC9eBs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.929.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.929.0/index.min.mjs": "sha384-LkLZwIP5p0KOZUY5QUuW/kmmJv8CSOLTJ9hbd+5Qz5M2ehw/ELZTg14ExSNC9eBs"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.929.0/LICENSE
```

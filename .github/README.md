...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.774.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.774.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-R7sduttczod+EB46BB2emm7rqa9S85NViNZ1MAKOGOi63Q4P4V1RQhrWSEmAp1oN
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.774.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.774.0/index.min.mjs": "sha384-R7sduttczod+EB46BB2emm7rqa9S85NViNZ1MAKOGOi63Q4P4V1RQhrWSEmAp1oN"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.774.0/LICENSE
```

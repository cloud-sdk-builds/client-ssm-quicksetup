...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.978.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.978.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-LTeLmf0BzjUnlmpfvZX82WA2oiA8AzIWq0rAfKEZ0Byxw+gZzUgwg1MZfzN+c/U4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.978.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.978.0/index.min.mjs": "sha384-LTeLmf0BzjUnlmpfvZX82WA2oiA8AzIWq0rAfKEZ0Byxw+gZzUgwg1MZfzN+c/U4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.978.0/LICENSE
```

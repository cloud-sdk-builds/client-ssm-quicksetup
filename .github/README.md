...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1010.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1010.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TH6rkqfbHMzi2iM8+G8XCl+QdtdVzn3Ukj4AauHp8KPOyzZZMXYlib7bdbC7hbea
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1010.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1010.0/index.min.mjs": "sha384-TH6rkqfbHMzi2iM8+G8XCl+QdtdVzn3Ukj4AauHp8KPOyzZZMXYlib7bdbC7hbea"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1010.0/LICENSE
```

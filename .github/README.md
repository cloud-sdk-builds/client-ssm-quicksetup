...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.995.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.995.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EJgMh7UryGDVHzb+aIZEQqkKRG3e7wKTHFKdmcm5oWhY+DQsXlB1snbdS3o7LKqE
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.995.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.995.0/index.min.mjs": "sha384-EJgMh7UryGDVHzb+aIZEQqkKRG3e7wKTHFKdmcm5oWhY+DQsXlB1snbdS3o7LKqE"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.995.0/LICENSE
```

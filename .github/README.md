...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.698.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.698.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ycsbD7EN2M+npw7yC9B2/GxzjIj8pR50kJzyw78hwR/wwbmWCGR7IiDvsqoGprEI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.698.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.698.0/index.min.mjs": "sha384-ycsbD7EN2M+npw7yC9B2/GxzjIj8pR50kJzyw78hwR/wwbmWCGR7IiDvsqoGprEI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.698.0/LICENSE
```

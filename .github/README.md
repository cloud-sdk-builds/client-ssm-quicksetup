...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.731.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.731.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Qk94ce4d/NAGlWSSU399gWMl41fRHiCy98PEcIqgORLypZHX/cSsn7Ol3dFovrEd
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.731.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.731.0/index.min.mjs": "sha384-Qk94ce4d/NAGlWSSU399gWMl41fRHiCy98PEcIqgORLypZHX/cSsn7Ol3dFovrEd"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.731.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uXpISVExW1OH99M0ukZexOYBqoGwQASPCafpT/6Yuau9Xe3ZYSKz/rdIC5vtmO+o
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.899.0/index.min.mjs": "sha384-uXpISVExW1OH99M0ukZexOYBqoGwQASPCafpT/6Yuau9Xe3ZYSKz/rdIC5vtmO+o"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.899.0/LICENSE
```

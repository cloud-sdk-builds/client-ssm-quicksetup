...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.798.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.798.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-4sQmjG/0EE/LPnhKZsIBg5BGOdDyay8t4fwPlOtw4cYjB2qRXtaUGopPMWF+8M+a
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.798.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.798.0/index.min.mjs": "sha384-4sQmjG/0EE/LPnhKZsIBg5BGOdDyay8t4fwPlOtw4cYjB2qRXtaUGopPMWF+8M+a"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.798.0/LICENSE
```

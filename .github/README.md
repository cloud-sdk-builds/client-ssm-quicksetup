...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.629.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.629.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ZhISdr8pfMMFAigdhYH5W5fkW1MQrRHo5EBFMFUwa8B8MFPkTgoH2tnIbt1XVZ/6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.629.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.629.0/index.min.mjs": "sha384-ZhISdr8pfMMFAigdhYH5W5fkW1MQrRHo5EBFMFUwa8B8MFPkTgoH2tnIbt1XVZ/6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.629.0/LICENSE
```

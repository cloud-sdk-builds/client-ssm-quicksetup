...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.907.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.907.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oqBU81DWurepjMK8FPghZqhMGukxlniD6CUTqs+TbG9Uet+BXb1NzpXTvb1LQ5OZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.907.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.907.0/index.min.mjs": "sha384-oqBU81DWurepjMK8FPghZqhMGukxlniD6CUTqs+TbG9Uet+BXb1NzpXTvb1LQ5OZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.907.0/LICENSE
```

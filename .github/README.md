...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.917.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.917.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+GHPVEvk7Ufr3I2GgLdB5EM1HDZMUTMEabnxIqq6Vb7M0Gb78OsMfsNgfHXvZgkI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.917.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.917.0/index.min.mjs": "sha384-+GHPVEvk7Ufr3I2GgLdB5EM1HDZMUTMEabnxIqq6Vb7M0Gb78OsMfsNgfHXvZgkI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.917.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.696.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.696.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-qk1foX5ffoSWEZfKBAMsCAYkDTenT1h2Rd+LX2kX03OkoT0l7v+isdQJ55r1HzXn
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.696.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.696.0/index.min.mjs": "sha384-qk1foX5ffoSWEZfKBAMsCAYkDTenT1h2Rd+LX2kX03OkoT0l7v+isdQJ55r1HzXn"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.696.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.935.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.935.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-ouH1REuqStoZyc6s2RZJbSTd7ZaVjiNEqCsYghG4S0I0lQLXOpSA7qggWy7NR5w4
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.935.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.935.0/index.min.mjs": "sha384-ouH1REuqStoZyc6s2RZJbSTd7ZaVjiNEqCsYghG4S0I0lQLXOpSA7qggWy7NR5w4"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.935.0/LICENSE
```

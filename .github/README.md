...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.986.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.986.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-lfzwusFP8KYxixt8equOrcVTXHAtY4/zLq5VkWa2CosCUXk5MHbodxxEiMFaaJ1h
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.986.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.986.0/index.min.mjs": "sha384-lfzwusFP8KYxixt8equOrcVTXHAtY4/zLq5VkWa2CosCUXk5MHbodxxEiMFaaJ1h"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.986.0/LICENSE
```

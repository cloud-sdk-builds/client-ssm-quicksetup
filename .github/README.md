...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.879.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.879.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-h3/KNO0sMrcimGvhB+E2eY1Lt66hbYxvit7aFfkbqwuHacwAEQR/fiaNKIKXkYCG
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.879.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.879.0/index.min.mjs": "sha384-h3/KNO0sMrcimGvhB+E2eY1Lt66hbYxvit7aFfkbqwuHacwAEQR/fiaNKIKXkYCG"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.879.0/LICENSE
```

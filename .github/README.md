...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.670.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.670.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-Keur0Ee3Lm4Kj0y/e4i3NT9edKhAQx7KpR6sCtQVC/jwDzTcBvO4VpHrdeeRstZS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.670.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.670.0/index.min.mjs": "sha384-Keur0Ee3Lm4Kj0y/e4i3NT9edKhAQx7KpR6sCtQVC/jwDzTcBvO4VpHrdeeRstZS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.670.0/LICENSE
```

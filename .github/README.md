...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.650.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.650.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-STSAD4h7kPUxC37PD75V1Pa7TOc4wPrfp0/JA5hTWvZ2dBBTPjMC3v5VCRoiitdz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.650.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.650.0/index.min.mjs": "sha384-STSAD4h7kPUxC37PD75V1Pa7TOc4wPrfp0/JA5hTWvZ2dBBTPjMC3v5VCRoiitdz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.650.0/LICENSE
```

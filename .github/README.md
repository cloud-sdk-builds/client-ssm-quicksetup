...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.750.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.750.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-UXDcnodOLvCWMD/j1cPNKiFITkh9aqwMr/3aVs1sds8OnpsfTzUSFShJ36a3VGlk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.750.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.750.0/index.min.mjs": "sha384-UXDcnodOLvCWMD/j1cPNKiFITkh9aqwMr/3aVs1sds8OnpsfTzUSFShJ36a3VGlk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.750.0/LICENSE
```

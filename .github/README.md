...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.749.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.749.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DMh7AKaswQA+Ez3T9Yx7SIFhG8XdVYP/ywWeoUvZpgDQngcySJP6T9m9d9Bl4R5y
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.749.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.749.0/index.min.mjs": "sha384-DMh7AKaswQA+Ez3T9Yx7SIFhG8XdVYP/ywWeoUvZpgDQngcySJP6T9m9d9Bl4R5y"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.749.0/LICENSE
```

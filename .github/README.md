...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.925.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.925.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-EmJPboCmszbl4h6mrC9mTRid0IQ+1bQ1dB+PRALDKPgg2I2bgojXVmw/VciN5+pu
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.925.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.925.0/index.min.mjs": "sha384-EmJPboCmszbl4h6mrC9mTRid0IQ+1bQ1dB+PRALDKPgg2I2bgojXVmw/VciN5+pu"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.925.0/LICENSE
```

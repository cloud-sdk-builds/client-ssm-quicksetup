...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.675.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.675.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-bHPo8MvLtaeNYobAQfV+BmZ2++RMrcyEsJtW4MRtFYN2//5JPi82SLA25j9Sq0Dg
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.675.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.675.0/index.min.mjs": "sha384-bHPo8MvLtaeNYobAQfV+BmZ2++RMrcyEsJtW4MRtFYN2//5JPi82SLA25j9Sq0Dg"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.675.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.726.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.726.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-rBp2eOh8xshLry0f3NfxkQ2709o2ddkmmjPsROZBVH9mxpq9Vwiyd7nA3noMPhIZ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.726.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.726.0/index.min.mjs": "sha384-rBp2eOh8xshLry0f3NfxkQ2709o2ddkmmjPsROZBVH9mxpq9Vwiyd7nA3noMPhIZ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.726.0/LICENSE
```

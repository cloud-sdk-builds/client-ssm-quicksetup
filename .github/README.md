...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.812.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.812.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-vBVwFssFUlhjXl4fqmOXqb2Usc0NDrcP/Mp0u+JmmVqqbNA2FawD8lLD3wKL2gCI
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.812.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.812.0/index.min.mjs": "sha384-vBVwFssFUlhjXl4fqmOXqb2Usc0NDrcP/Mp0u+JmmVqqbNA2FawD8lLD3wKL2gCI"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.812.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.991.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.991.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-wxP6i8OOaopFG5kCOP6E8SP+nZR6buFC75ZRbPhFndSvimADVSj6J9WuiW1hYIJJ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.991.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.991.0/index.min.mjs": "sha384-wxP6i8OOaopFG5kCOP6E8SP+nZR6buFC75ZRbPhFndSvimADVSj6J9WuiW1hYIJJ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.991.0/LICENSE
```

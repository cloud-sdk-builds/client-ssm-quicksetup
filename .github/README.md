...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.928.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.928.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-6UyWTpkvpj9Aw1eiefQKBt20SYPbUXpiq4szKsaRFwvYy2pTOTEMeQP0RF+g7Qlv
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.928.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.928.0/index.min.mjs": "sha384-6UyWTpkvpj9Aw1eiefQKBt20SYPbUXpiq4szKsaRFwvYy2pTOTEMeQP0RF+g7Qlv"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.928.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.686.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.686.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TT95YxWhV+177OyHxpbbjD3cKv8cPldggqeuRRpUj/rGDeGu0kXqyf4DoB1G/TX+
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.686.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.686.0/index.min.mjs": "sha384-TT95YxWhV+177OyHxpbbjD3cKv8cPldggqeuRRpUj/rGDeGu0kXqyf4DoB1G/TX+"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.686.0/LICENSE
```

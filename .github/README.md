...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.654.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.654.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-+duTGw1ZwkFGNritC3o4CdXpzY2a6gdDAU1cEDtbKnJEv8TeCO1tYkQH3epL0jY7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.654.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.654.0/index.min.mjs": "sha384-+duTGw1ZwkFGNritC3o4CdXpzY2a6gdDAU1cEDtbKnJEv8TeCO1tYkQH3epL0jY7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.654.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.830.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.830.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-FZsPuU1n+qhrugq4/2J2OgGIzRDKf6eEjZLaaDC2QDNzFx85wZ0bHuspdfMZB025
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.830.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.830.0/index.min.mjs": "sha384-FZsPuU1n+qhrugq4/2J2OgGIzRDKf6eEjZLaaDC2QDNzFx85wZ0bHuspdfMZB025"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.830.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.918.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.918.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yWSpRkIIeTnNhOxbjeAEc8N+qLXNopZ4mT8xvCUCmJqRb68SCa0yyOmm8H/9acH5
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.918.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.918.0/index.min.mjs": "sha384-yWSpRkIIeTnNhOxbjeAEc8N+qLXNopZ4mT8xvCUCmJqRb68SCa0yyOmm8H/9acH5"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.918.0/LICENSE
```

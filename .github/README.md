...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.631.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.631.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3/v1pIdLRgDNxiF5rOVtB4k9WJIJvm9XaA8YUr2h5CCZ7Fdtg1pzgM0CPnPSwXLk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.631.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.631.0/index.min.mjs": "sha384-3/v1pIdLRgDNxiF5rOVtB4k9WJIJvm9XaA8YUr2h5CCZ7Fdtg1pzgM0CPnPSwXLk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.631.0/LICENSE
```

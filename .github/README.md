...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.714.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.714.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-zt/e5qcvlKdoo0SuNy/Wk4rCj8mKtvHBws4kBpYun9FGe43VzZAe53Ov1cP7Y1ND
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.714.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.714.0/index.min.mjs": "sha384-zt/e5qcvlKdoo0SuNy/Wk4rCj8mKtvHBws4kBpYun9FGe43VzZAe53Ov1cP7Y1ND"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.714.0/LICENSE
```

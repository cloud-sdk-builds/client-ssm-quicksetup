...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.666.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.666.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-GvoYFyR9z+GQSB/8BHugCxrg1ppKHTXtVhM9VMXNzq6Z9jodtKGJ6YjMLg39P1kL
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.666.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.666.0/index.min.mjs": "sha384-GvoYFyR9z+GQSB/8BHugCxrg1ppKHTXtVhM9VMXNzq6Z9jodtKGJ6YjMLg39P1kL"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.666.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.726.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.726.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-gm5LK7UuX1qYS+JEAGXfFDxOwe77W2Ox3eI5+cjw8G3BnEsDYaUO8EGh9RLFTKA8
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.726.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.726.1/index.min.mjs": "sha384-gm5LK7UuX1qYS+JEAGXfFDxOwe77W2Ox3eI5+cjw8G3BnEsDYaUO8EGh9RLFTKA8"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.726.1/LICENSE
```

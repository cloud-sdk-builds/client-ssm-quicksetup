...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.919.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.919.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-yZouBS+Qm6/7cepbNW5XlT23WDIJ4F35mDUzqnTA4MgHuaa5i8+zi2ypf0ou/vGR
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.919.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.919.0/index.min.mjs": "sha384-yZouBS+Qm6/7cepbNW5XlT23WDIJ4F35mDUzqnTA4MgHuaa5i8+zi2ypf0ou/vGR"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.919.0/LICENSE
```

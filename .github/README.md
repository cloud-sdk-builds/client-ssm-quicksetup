...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.691.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.691.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HCgmSZt/tej7odk7kv2J7QtFuoMshEpKFiPRSAo8e5E+NoZyVzJUMT4St2C8s0W7
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.691.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.691.0/index.min.mjs": "sha384-HCgmSZt/tej7odk7kv2J7QtFuoMshEpKFiPRSAo8e5E+NoZyVzJUMT4St2C8s0W7"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.691.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.982.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.982.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-aAk/R7fzlbNgrc4wNR/TB0nmPmN3MKVeA3j116/CmZsGguDWguvUCxqNonui678X
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.982.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.982.0/index.min.mjs": "sha384-aAk/R7fzlbNgrc4wNR/TB0nmPmN3MKVeA3j116/CmZsGguDWguvUCxqNonui678X"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.982.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.731.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.731.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-QfivWWjeeg1RdPzbP2l/udaYKz5FO9QJdu3fAWycoDAv3kcQi8nacRBMmSp2sQ0j
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.731.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.731.1/index.min.mjs": "sha384-QfivWWjeeg1RdPzbP2l/udaYKz5FO9QJdu3fAWycoDAv3kcQi8nacRBMmSp2sQ0j"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.731.1/LICENSE
```

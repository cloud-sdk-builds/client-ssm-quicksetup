...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.658.1).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.658.1/index.min.mjs
```

SRI SHA Hash

```text
sha384-MZRopKrvMKoFtMP5hQOGRxcmS8geZu7klFaG1l8SY+1D+tMmS6rrNlU1YIe1FFWQ
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.658.1/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.658.1/index.min.mjs": "sha384-MZRopKrvMKoFtMP5hQOGRxcmS8geZu7klFaG1l8SY+1D+tMmS6rrNlU1YIe1FFWQ"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.658.1/LICENSE
```

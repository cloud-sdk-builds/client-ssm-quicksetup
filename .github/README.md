...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1013.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1013.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-HyjfbG8OkssVqW+21eqjM2GQUgDRhqdzWnXbKby8K+Mz2ZbAK6sLLubQ5d0ezHRH
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1013.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1013.0/index.min.mjs": "sha384-HyjfbG8OkssVqW+21eqjM2GQUgDRhqdzWnXbKby8K+Mz2ZbAK6sLLubQ5d0ezHRH"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1013.0/LICENSE
```

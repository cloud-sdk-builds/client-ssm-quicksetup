...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1036.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1036.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-oZFnjMpNf17+nSC1+cZKG6T7i6VmvXpzab0GYo6DybcnH/S6I84xYzGkc8rmf8Jz
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1036.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1036.0/index.min.mjs": "sha384-oZFnjMpNf17+nSC1+cZKG6T7i6VmvXpzab0GYo6DybcnH/S6I84xYzGkc8rmf8Jz"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1036.0/LICENSE
```

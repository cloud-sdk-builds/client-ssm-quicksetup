...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.857.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.857.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-XCl8VUOuxz7mTRG5RI5kcshUKhpAqeIbW9Amx54m3wYYUIyoP7cO/nmjterfbFaS
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.857.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.857.0/index.min.mjs": "sha384-XCl8VUOuxz7mTRG5RI5kcshUKhpAqeIbW9Amx54m3wYYUIyoP7cO/nmjterfbFaS"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.857.0/LICENSE
```

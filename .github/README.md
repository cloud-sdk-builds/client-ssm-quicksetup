...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.713.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.713.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-DtTW9ijnRi4rtGKkWQYYfKLMVQfH0LfYL+oRsMhhwoCA8lIQL4tb3SjqMevqj7VA
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.713.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.713.0/index.min.mjs": "sha384-DtTW9ijnRi4rtGKkWQYYfKLMVQfH0LfYL+oRsMhhwoCA8lIQL4tb3SjqMevqj7VA"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.713.0/LICENSE
```

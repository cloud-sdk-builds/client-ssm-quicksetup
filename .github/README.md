...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1004.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1004.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-V1UPhsITRcHpMVt7o5A2VnBEQtkobNVPSBk/q6+1gkCUJN08kIRxhAfUGY1h1T1r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1004.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1004.0/index.min.mjs": "sha384-V1UPhsITRcHpMVt7o5A2VnBEQtkobNVPSBk/q6+1gkCUJN08kIRxhAfUGY1h1T1r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1004.0/LICENSE
```

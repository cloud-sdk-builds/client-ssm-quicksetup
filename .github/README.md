...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.914.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.914.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-nU9q4ew2rIPqoZiqMjFeH62GGffncaT93ysN7modNfiNxmbvEwIRCHQmsdUkcZFr
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.914.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.914.0/index.min.mjs": "sha384-nU9q4ew2rIPqoZiqMjFeH62GGffncaT93ysN7modNfiNxmbvEwIRCHQmsdUkcZFr"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.914.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.906.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.906.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-hycSpBV2azR6HcQtAMFpikK1ponmjgG4ea20kMLoy3CwGC8YS0isKF5aXHqATcWk
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.906.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.906.0/index.min.mjs": "sha384-hycSpBV2azR6HcQtAMFpikK1ponmjgG4ea20kMLoy3CwGC8YS0isKF5aXHqATcWk"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.906.0/LICENSE
```

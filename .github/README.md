...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.826.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.826.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-/XgyvWMzgS707vjJ9pimCnI41iY6Mu+gbtZWVzlZC8OorXNmAN+bZAHb+e3FB0VK
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.826.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.826.0/index.min.mjs": "sha384-/XgyvWMzgS707vjJ9pimCnI41iY6Mu+gbtZWVzlZC8OorXNmAN+bZAHb+e3FB0VK"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.826.0/LICENSE
```

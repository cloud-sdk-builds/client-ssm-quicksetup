...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.1021.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1021.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-anS1LiiJYTNe/C/u4Z84tZXM4X/78HtKiLY83NaaNO7/4yeBuJxucRzXeROtQ17l
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1021.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.1021.0/index.min.mjs": "sha384-anS1LiiJYTNe/C/u4Z84tZXM4X/78HtKiLY83NaaNO7/4yeBuJxucRzXeROtQ17l"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.1021.0/LICENSE
```

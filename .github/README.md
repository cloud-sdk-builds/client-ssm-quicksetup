...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.970.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.970.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-TQUOt5mRbB6um4vjk5zjK2snDbO9Xo9SPL53fDPiCPOZvnvlJgtDyxlgly325m8/
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.970.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.970.0/index.min.mjs": "sha384-TQUOt5mRbB6um4vjk5zjK2snDbO9Xo9SPL53fDPiCPOZvnvlJgtDyxlgly325m8/"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.970.0/LICENSE
```

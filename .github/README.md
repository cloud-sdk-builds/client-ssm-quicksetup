...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.958.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.958.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-YaHixpY0X3D504VGfmC21OikOegcTs1wNTK7tOZgqL+Oo21GiZ5UTN4flcerTott
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.958.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.958.0/index.min.mjs": "sha384-YaHixpY0X3D504VGfmC21OikOegcTs1wNTK7tOZgqL+Oo21GiZ5UTN4flcerTott"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.958.0/LICENSE
```

...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.775.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.775.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-3mSxAdTXcVkGy71z2cgWvNWmXTwfBMN4QUW24NIihpYnuCwMs3kFGs07XoNRv+5r
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.775.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.775.0/index.min.mjs": "sha384-3mSxAdTXcVkGy71z2cgWvNWmXTwfBMN4QUW24NIihpYnuCwMs3kFGs07XoNRv+5r"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.775.0/LICENSE
```

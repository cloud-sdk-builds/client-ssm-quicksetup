...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.797.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.797.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-SpcdKNBE3mtkFzttmShmpzcwVdq4/RXxvSAdLEfUc6Y/Uuo9i0rcTfyJOymMJi+1
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.797.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.797.0/index.min.mjs": "sha384-SpcdKNBE3mtkFzttmShmpzcwVdq4/RXxvSAdLEfUc6Y/Uuo9i0rcTfyJOymMJi+1"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.797.0/LICENSE
```

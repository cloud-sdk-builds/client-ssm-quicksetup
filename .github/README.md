...
[`@aws-sdk/client-ssm-quicksetup`](https://www.npmjs.com/package/@aws-sdk/client-ssm-quicksetup/v/3.844.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.844.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-P8jb1uroa5aFhscXZ6ui7ZRKFSC1ikWGCM0xLi1hHPbipTG5EM/AG36CtHsN6OM9
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-ssm-quicksetup": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.844.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-ssm-quicksetup@3.844.0/index.min.mjs": "sha384-P8jb1uroa5aFhscXZ6ui7ZRKFSC1ikWGCM0xLi1hHPbipTG5EM/AG36CtHsN6OM9"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-ssm-quicksetup/blob/refs/tags/3.844.0/LICENSE
```
